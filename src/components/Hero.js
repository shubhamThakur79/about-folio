        ...
        <div className="mt-[90px] lg:px-10 lg:pl-32 pt-[70px] mb-8 h-[95vh] lg:h-[80vh] border-neutral-400 md:border-black/40 lg:mb-35">
                ...
                <div className="hidden lg:block w-full lg:w-1/2 lg:8">
                    <div className="flex justify-center">
                        <motion.img
                            ...
                            transition={{ duration: 1, delay: 1 }}
                            className="mt-[55px] ml-[240px] shadow-sm shadow-slate-950 rounded-tr-full rounded-bl-full rounded-br-full rounded-tl-full lg:rounded-br-[150px] lg:rounded-bl-[150px]"
                            src="/logo.png"
                            alt=""
                        />
                    </div>
            ...
            >
                <a 
                    ...
                    href="public/Shubham'sResume.pdf"
                >
                    Get Resume
                </a>
            </motion.div>
